function [ num_curr_char, history_ ] = showTimeToCompletion_alt( percent_complete, num_prev_char, history_, startTime )
...
txt = sprintf( ...
    ...
    'Expected Finish: %s'], ...
    ratio * 100, ...
    [datestr(seconds(tElapsed),'hh:MM:SS')], ..., dd'), 'days'], ... floor(tRem/60), ...    rem(tRem,60), ...
