classdef Searchlight_CanonCorr < CanonCorr_Base
    properties
        targetPropInVx
        targetRoiTemplate
        analyserapply
    ...
    methods
        function obj = Searchlight_CanonCorr(opts)
            arguments
                opts (1, 1) struct
            end
            ...
            for channel = opts.channel
                ...
                for radius = opts.radius
                    ...
                    if ~exist(coeff_file, 'file')
                        ...
                        [coeff, center_indices] = searchlight(sourceRegion2D, obj.targetPropInVx, ...
                    ...
                    for i = 1:numel(center_indices)
                        ...
                        [pval_full{i, template_index, ch_indx}, ...
                            ...
                            corr_res_perm{i, template_index, ch_indx}] = gli2subjects( ...
                                sourceRoi, targetRoi, feature_regressors, 'coeff', coeff{i}, ...
